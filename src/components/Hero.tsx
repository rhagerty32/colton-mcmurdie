...
export default function Hero() {
    return (
        <section className="relative h-screen flex items-center justify-center overflow-hidden bg-white">
            ...
            {/* Content */}
            <div className="relative z-10 text-center max-w-6xl -mt-20 mx-auto px-4">
                <h1 className="font-western text-6xl md:text-9xl font-black mb-8 text-accent leading-none">
                    COLTON
                </h1>
                <p className="text-lg md:text-xl mb-12 text-accent uppercase tracking-widest font-medium">
                    Music Video • Concert and Bull Riding
                </p>
